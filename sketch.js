...
function setup() {
  ...
  leftWall = new Base(24, height / 2 + 50, 400, 100, "#8d6e63", true);
  rightWall = new Base(width - 150, height / 2 + 50, 400, 100, "#8d6e63", true);
  ...
  jointPoint = new Base(width - 350, height / 2 + 40, 40, 20, "#8d6e63", true);
